...
@section('content')
        ...
        <div class="container pb-5">
            <div class="row gap-2">
                <div class="col-sm order-sm-2">
                    <img src="Front/assets/images/default/banner.jpg" class="img-fluid banner-img banner-img"
            ...
            @forelse ($majors as $major)
                <div class="card p-2" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        ...
                        <a href="{{ route('doctor.index', $major->id) }}" class="btn btn-outline-primary card-button">Browse
                            Doctors</a>
                    </div>
                </div>
            @empty
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    ...
                                    @auth
                                    <a href="{{route('booking.create',$doctor->id)}}" class="btn btn-outline-primary card-button">Book an
                                        appointment</a>
                                    @endauth
                                    @guest
    ...
    <div class="banner container d-block d-lg-grid d-md-block d-sm-block">
        ...
        <div class="bottom--right bg-blue text-white">
            <img src="Front/assets/images/default/banner.jpg" class="img-fluid banner-img">
        </div>
    </div>
@endsection
